        ...
        <a href="${description}" class="flex bg-white shadow-md my-6 mx-2 p-3 rounded border-l-4 border-teal-500 border-solid">
          ...
          <div class="flex-grow">
            ...
            <div class="flex items-center flex-wrap mt-2">
              ${
                reloc &&
                `<div class="mr-2 mb-2 md:mb-0 bg-teal-500 text-sm text-teal-100 p-1 px-2 rounded-full uppercase">${reloc}</div>`
              }
              ${
                visa &&
                `<div class="mr-2 mb-2 md:mb-0 bg-purple-500 text-sm text-purple-100 p-1 px-2 rounded-full uppercase">${visa}</div>`
              }
            </div>
